...
CSSLint.addRule({
    ...
    init: function (parser, reporter) {
        ...
        function createSpectrum(mins, maxs) {
            var spectrumMin = [],
                spectrumMax = [];
        ...
        function analyzeBreakPoints(mins, maxs) {
            mins.sort(sort);
            maxs.sort(sort);
        ...
        parser.addListener("startmedia", function (event) {
            ...
            if (regexResult) {
                ...
                maxBreakPoints.push(value);
            }
        });

        parser.addListener("endstylesheet", function () {
           var spectrum = analyzeBreakPoints(minBreakPoints, maxBreakPoints);
            console.log(minBreakPoints);
        });
    }
});
